...
export default function ReachUs() {
  ...
  return (
    <div className="px-10 pt-20 z-50 min-h-screen flex flex-row align-middle items-start">
      <div className="w-[60%]">
        <form action="" className="grid grid-cols-2 gap-x-7">
          {/* <div className="flex flex-col justtify-center items-center"> */}
        <h1 className="text-center text-xl font-bold col-span-2">Lets get in touch</h1>
      ...
      <div className="w-[40%] px-5 flex flex-col ">
        <h1 className="text-center text-xl font-bold">We are all ears for you</h1>
